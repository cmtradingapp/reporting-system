ROLE_MAP = {
    ...
    "retention_bg_team1": (
        "u.department_ = %s AND u.office = %s AND u.department = %s",
        ["Retention", "BG", "BG Team 1"],
    ),
    "retention_bg_team2": (
        "u.department_ = %s AND u.office = %s AND u.department = %s",
        ["Retention", "BG", "BG Team 2"],
    ),
    "retention_bg_team3": (
        "u.department_ = %s AND u.office = %s AND u.department = %s",
        ["Retention", "BG", "BG Team 3"],
    ),
    "retention_abj_ng_team1": (
        "u.department_ = %s AND u.office = %s AND u.department = %s",
        ["Retention", "ABJ-NG", "NG Team 1"],
    ),
    "retention_abj_ng_team2": (
        "u.department_ = %s AND u.office = %s AND u.department = %s",
        ["Retention", "ABJ-NG", "NG Team 2"],
    ),
    "retention_abj_ng_team3": (
        "u.department_ = %s AND u.office = %s AND u.department = %s",
        ["Retention", "ABJ-NG", "NG Team 3"],
    ),
